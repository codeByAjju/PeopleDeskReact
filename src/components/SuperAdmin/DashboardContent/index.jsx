          ...
          <div className="col-12 col-xl-8">
            <div className="panel">
              <div className="panel-header">
                ...
                <a className="btn btn-light btn-sm" href="#charts">
                  View Details
                </a>
              </div>
              ...
              <tbody>
                <tr>
                  ...
                  <td className="text-end">
                    <a className="btn btn-light btn-sm" href="#user-details">
                      View
                    </a>
                  </td>
                </tr>
                ...
                <tr>
                  <td>
                    <div className="d-flex align-items-center gap-2">
                      ...
                      />
                      <div>
                        <p className="fw-semibold mb-0">Fatima Al-Mansouri</p>
                        <p className="text-muted small mb-0">
                          fatima@example.com
                        </p>
                      </div>
                ...
                <tr>
                  <td>
                    <div className="d-flex align-items-center gap-2">
                      ...
                      />
                      <div>
                        <p className="fw-semibold mb-0">Michael Chen</p>
                        <p className="text-muted small mb-0">
                          michael@example.com
                        </p>
                      </div>
