                        ...
                        <div className="col-12 col-xl-4">
                            <div className="panel h-100 text-center profile-card">
                                ...
                                <div className="d-flex justify-content-center gap-2">
                                    <span className="badge text-bg-primary bg-primary">Admin</span>
                            ...
                            <form className="panel needs-validation" noValidate="">
                                ...
                                <div className="row g-3">
                                    ...
                                    <div className="col-12">
                                        ...
                                        <textarea
                                            ...
                                            rows={5}
                                            defaultValue={
                                                "Focused on clean admin workflows, reusable UI systems, and reliable operations."
                                            }
                                        />
                                    </div>
                                </div>
                                <div className="d-flex justify-content-end mt-4">
                                    <button className="btn btn-primary" type="submit">
                                        <i className="bi bi-check2-circle" aria-hidden="true" /> Save
                                        Profile
                                    </button>
                                </div>
                            </form>
